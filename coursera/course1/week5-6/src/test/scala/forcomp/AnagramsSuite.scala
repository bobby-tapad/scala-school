...
class AnagramsSuite {
  ...
  @Test def `wordOccurrences2: abcd (3pts)`: Unit =
    assertEquals(List(('a', 1), ('b', 1), ('c', 1), ('d', 1)), wordOccurrences2("abcd"))

  @Test def `wordOccurrences2: Robert (3pts)`: Unit =
    assertEquals(List(('b', 1), ('e', 1), ('o', 1), ('r', 2), ('t', 1)), wordOccurrences2("Robert"))
